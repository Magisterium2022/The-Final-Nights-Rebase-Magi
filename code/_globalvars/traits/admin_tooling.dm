...
GLOBAL_LIST_INIT(admin_visible_traits, list(
	...
	/mob = list(
		...
		"TRAIT_CURRENTLY_SIDESTEPPING" = TRAIT_CURRENTLY_SIDESTEPPING,  // DARKPACK EDIT ADD - WEREWOLF
		...
		"TRAIT_NO_SIDESTEPPING" = TRAIT_NO_SIDESTEPPING,  // DARKPACK EDIT ADD - WEREWOLF
		...
		"TRAIT_UNSCENTED" = TRAIT_UNSCENTED, // TFN EDIT ADD - Garou Scent
	),
	/obj/item = list(
